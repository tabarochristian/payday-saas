    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    core.models.fields.foreignkey.ForeignKey(
                        default=None,
                        limit_choices_to={"app_label__in": ["employee"]},
                        null=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    core.models.fields.imagefield.ImageField(
                        blank=True,
                        default=None,
                        help_text="Logo de la sous-organisation - Dimension 64x64",
                        null=True,
                        upload_to=core.utils.upload_directory_file,
                        verbose_name="logo",
                    ),
            ...
            options={
                ...
                "verbose_name_plural": "sous-organisation(s)",
            },
        ),
        migrations.CreateModel(
            name="Template",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "users",
                    core.models.fields.model_select_to_multiple_field.ModelSelect2Multiple(
                        to=settings.AUTH_USER_MODEL, verbose_name="validateur(s)"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    core.models.fields.booleanfield.BooleanField(
                        default=False,
                        help_text="Indique si l'utilisateur ou le groupe peut voir ce champ.",
                        verbose_name="en lecture seule",
                    ),
                ),
                (
                    "can_edit",
                    core.models.fields.booleanfield.BooleanField(
                        default=False,
                        help_text="Indique si l'utilisateur ou le groupe peut modifier ce champ.",
            ...
            options={
                "verbose_name": "Filtrage dynamique des colones",
                "verbose_name_plural": "Filtrage dynamique des colones",
                "unique_together": {
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "field",
                    core.models.fields.charfield.CharField(
                        help_text="Le champ auquel cette règle de sécurité s'applique.",
                        max_length=255,
                        verbose_name="champ",
                    ),
                ),
                (
                    "value",
                    core.models.fields.charfield.CharField(
                        help_text="La valeur du champ à laquelle cette règle de sécurité s'applique.",
                        max_length=255,
                        verbose_name="valeur",
                    ),
                ),
            ...
            options={
                "verbose_name": "Filtrage dynamique des lignes",
                "verbose_name_plural": "Filtrage dynamique des lignes",
                "unique_together": {
                    ("group", "content_type", "field"),
                    ("user", "content_type", "field"),
                },
