...
from core.models.fields.capture_field import CaptureField
...
class Employee(BaseEmployee):
    create_user_on_save = fields.BooleanField(
        ...
        default=False,
        help_text=_(
            'Créez un utilisateur pour cet employé si l\'adresse e-mail est fournie.')
    )
    ...
    devices = fields.ModelSelect2Multiple(
        ...
        help_text=_(
            'Veuillez choisir les terminaux de présence que l\'agent utilisera pour pointer.'),
        blank=True
    )
    ...
    list_display = ('registration_number', 'last_name',
                    'middle_name', 'branch', 'designation', 'grade', 'status')
    inlines = ['employee.document', 'employee.education',
               'employee.child', 'payroll.specialemployeeitem']
